                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td  >
                                        ...
                                        <a href="?page=data&actions=edit&id_barang=<?= $data['id_barang'] ?>" class="btn btn-warning btn-xs">
                                            <span class="fa fa-edit"></span>
                                        </a>
                                        <a href="?page=data&actions=delete&id_barang=<?= $data['id_barang'] ?>" class="btn btn-danger btn-xs">
                                            <span class="fa fa-remove"></span>
                                        </a>
                                         <a href="?page=data&actions=move&id_barang=<?= $data['id_barang'] ?>" class="btn btn-info btn-xs">
